...
export class Backend {
	...
	public static async getPOI(borderBox: { southWest: LatLngLiteral, northEast: LatLngLiteral }, carName: string) {
		console.log("DFJNIEHFNIUESHNF SEFJNIO JSEFIJ SEOIJFO SEJFOI SEJOIFJ SEIOFJ")
		const raw = await fetch("http://localhost:8084/fires/firesLocations")
		console.log("DFJNIEHFNIUESHNF SEFJNIO JSEFIJ SEOIJFO SEJFOI SEJOIFJ SEIOFJ")
		const text = await raw.text();
		console.log("BOOM BOOM BOOM ICICICIICICICICICICI",text)
		try {
	...
	public static async getBarracks(borderBox: { southWest: LatLngLiteral, northEast: LatLngLiteral }, carName: string) {
		console.log("DFJNIEHFNIUESHNF SEFJNIO JSEFIJ SEOIJFO SEJFOI SEJOIFJ SEIOFJ")
		const raw = await fetch("http://localhost:8084/barracks/barracksLocations")
		console.log("DFJNIEHFNIUESHNF SEFJNIO JSEFIJ SEOIJFO SEJFOI SEJOIFJ SEIOFJ")
		const text = await raw.text();
		console.log("BOOM BOOM BOOM ICICICIICICICICICICI",text)
		try {
	...
	public static async getTrucks(borderBox: { southWest: LatLngLiteral, northEast: LatLngLiteral }, carName: string) {
		console.log("DFJNIEHFNIUESHNF SEFJNIO JSEFIJ SEOIJFO SEJFOI SEJOIFJ SEIOFJ")
		const raw = await fetch("http://localhost:8085/location")
		console.log("DFJNIEHFNIUESHNF SEFJNIO JSEFIJ SEOIJFO SEJFOI SEJOIFJ SEIOFJ")
		const text = await raw.text();
		console.log("BOOM BOOM BOOM ICICICIICICICICICICI",text)
		try {
